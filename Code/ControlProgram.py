...
def ShowReport():
    ...
    print("Show all mountain lion detections at a specific sensor location (4)")
    print("Show detection classifications by ranger (5)")
    print("Return (0)")
    while True:
        try:
...
def ShowByDate():
    print("All alerts from most recent to least recent.")
    db.report_3()
    BackToReport()
