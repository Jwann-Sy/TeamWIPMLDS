...
class Ui_reports_window(object):
    def setupUi(self, reports_window):
        ...
        self.classification_label.setGeometry(QtCore.QRect(20, 200, 201, 16))
        ...
        self.sensorid_enter_button.setGeometry(QtCore.QRect(340, 330, 81, 26))
        ...
        self.entries_by_ranger_label.setGeometry(QtCore.QRect(20, 380, 201, 16))
        ...
        self.rangerid_label.setGeometry(QtCore.QRect(20, 410, 101, 16))
        self.rangerid_label.setObjectName("rangerid_label")
        self.rangerid_text = QtWidgets.QLineEdit(self.centralwidget)
        self.rangerid_text.setGeometry(QtCore.QRect(140, 410, 181, 22))
